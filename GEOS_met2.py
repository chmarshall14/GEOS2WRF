...
out_folder = 'storm_'+ start.strftime('%Y%m%d') +'/MET2'
...
while now <= end:
   ...
   namelist.write("variableNamesOut(1)='SKINTEMP',\n")
   namelist.write("variableUnits(1)='K',\n")
   namelist.write("variableDescriptions(1)='effective_surface_skin_temperature',\n")
   namelist.write("\n")
   namelist.write("/\n")
