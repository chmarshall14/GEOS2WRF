...
from namelist_geos_scripts import download_start, download_end, path_to_storm, net_id, storm_name
...
sbatch.write("#SBATCH --mem=1GB\n")
sbatch.write("#SBATCH --ntasks-per-node=1\n")
