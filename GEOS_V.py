# -*- coding: utf-8 -*-
"""
Created on Thu May  7 23:16:48 2020
...
out_folder = '/scratch/cm5515/storm_'+ start.strftime('%Y%m%d') +'/V'
...
while now <= end:
   ...
   namelist.write("variableNamesIn(1)='V',\n") 
   namelist.write("variableNamesOut(1)='VV',\n") 
   namelist.write("variableUnits(1)='m s-1',\n") 
   namelist.write("variableDescriptions(1)='northward wind',\n") 
   namelist.write("\n")
   namelist.write("/\n")
