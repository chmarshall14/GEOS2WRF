# -*- coding: utf-8 -*-
"""
Created on Wed Aug 19 15:20:07 2020
...
wrfout=Dataset('control0_hist_d01_0', 'r')
# create empty arrays
storm_lats = np.array([])
storm_lons = np.array([])
storm_slps = np.array([])
...
pressure=getvar(wrfout,'p')
pressure=wrf.to_np(pressure)
pres=pressure[:, lon_min, lat_min]
slp_test=getvar(wrfout, 'slp')
