# -*- coding: utf-8 -*-
"""
Created on Thu May  7 13:36:54 2020
...
from namelist_geos_scripts import storm_folder, GEOS_start, GEOS_end, path_to_storm, path_to_geos2wps, iLonMin, iLonMax, jLatMin, jLatMax, storm_folder
os.chdir(path_to_storm)
start = GEOS_start
end= GEOS_end
#%% 
# The outfolder for this field was created by the download_wrapper
out_folder = storm_folder + '/H'
...
now=start
while now<= end:
    filename = 'c1440_NR' +'.' 'inst30mn_3d_H_Nv' +'.' + now.strftime('%Y%m%d_%H%Mz') + '.' +'nc4'
...
while now <= end:
   ...
   namelist.write("variableNamesIn(1)= 'H',\n") 
   namelist.write("variableNamesOut(1)= 'HGT',\n") 
   namelist.write("variableUnits(1)='m',\n") 
   namelist.write("variableDescriptions(1)='mid_layer_height',\n") 
   namelist.write("\n")
   namelist.write("\n")
   namelist.write("/\n")
